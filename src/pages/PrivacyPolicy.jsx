    ...
    <div className="legal-page">
      ...
      <div className="legal-container">
        ...
        <div className="legal-body">
          ...
          <h2>How we use it</h2>
          <p>We use your data to operate the core features of the site: hosting your book listings and author profile, converting and storing your manuscript files, connecting authors with freelancers, and understanding aggregate site usage so we can improve it. We do not sell your data.</p>

          <h2>Who we share it with</h2>
          <p>We don't share your personal data with third parties beyond the infrastructure providers that run the site (currently Supabase for authentication and storage). Freelancers and authors arrange their own working relationships and payment directly with each other — IndieConverters is not a party to those agreements and does not process payments on your behalf.</p>
