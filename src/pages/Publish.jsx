      ...
      <section className="section manuscript-templates" aria-labelledby="manuscript-templates-heading">
        <div className="container manuscript-templates-inner">
          <div className="manuscript-templates-copy">
            ...
            <h2 id="manuscript-templates-heading">Start with a clean sample page.</h2>
            <p>
              Download a small .docx starter, replace the sample text, and upload it when you are ready. Each file uses simple Word styles so conversion stays predictable.
            </p>
          </div>
